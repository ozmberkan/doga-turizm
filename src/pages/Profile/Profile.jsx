      ...
      <div className="bg-white dark:bg-gray-800 dark:border-gray-700 rounded-md w-full border sm:p-3 p-1.5 ">
        <div className="border-b dark:border-gray-700 sm:p-3 p-2 flex items-center justify-start gap-x-5">
          ...
          <div className="flex flex-col gap-y-1.5">
            <h1 className="sm:text-2xl text-base text-zinc-700 dark:text-white font-semibold">
              Hoş geldin, {user?.displayName}
            </h1>
            <p className="sm:text-sm text-xs text-zinc-700 dark:text-white">
        ...
        <div className="w-full px-5 flex flex-col gap-y-5 p-4">
          <TabGroup className="rounded-md  mt-2 flex flex-col gap-y-5">
            <TabList className="w-full flex justify-between items-center dark:bg-gray-700 bg-[#F4F4F5] px-4 py-2 gap-x-5 rounded-lg  ">
