...
const Invoice = () => {
  ...
  return (
    <div className="w-full h-screen items-center justify-center flex flex-col gap-y-2 px-4 sm:px-0">
      <div className="w-full sm:w-1/2 py-2 flex justify-end items-center">
        <button
          onClick={downloadPDF}
      ...
      <div
        className="p-4 rounded-md border w-full sm:w-1/2 bg-white overflow-hidden  "
        id="pdf-content"
      >
            ...
            <table className="w-full text-xs sm:text-sm text-left rtl:text-right text-gray-500 ">
              ...
              <tbody>
                <tr className="bg-white border-b ">
                  <th
                    scope="row"
                    className="px-1 sm:px-2 py-4 text-xs font-medium text-gray-900 whitespace-nowrap "
                  >
                    {findTicket.departure} - {findTicket.arrival} Otobüs Bileti
                  </th>
                  <td className="px-1 sm:px-2 py-4 ">{findTicket.ticketID}</td>
