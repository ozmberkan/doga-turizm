  ...
  return (
    <div className="w-full h-screen flex justify-center items-center ">
      <div className="flex flex-col items-center justify-center p-6  rounded-lg  max-w-2xl w-full text-center">
        ...
        <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-rubik font-medium text-black dark:text-white mt-4 mb-6 px-4">
          Aradığınız sayfa burada değil, sayfayı bulamadık ya da yapım
          aşamasındayız, ama size yardımcı olmak için buradayız.
        </h1>
        <p className="text-sm sm:text-base text-zinc-600/70 dark:text-white mb-6">
          Üzgünüz, lütfen ana sayfaya dönün veya arama yapın.
        </p>
        <Link
          to="/"
          className="px-4 py-2 dark:bg-gray-950 dark:border-gray-800 dark:hover:border-white bg-primary text-white border rounded-md font-rubik hover:bg-green-500 transition-colors duration-300"
        >
          Anasayfaya geri dön!
        </Link>
      </div>
