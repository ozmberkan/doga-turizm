...
const Footer = () => {
  return (
    <div className="container w-full sm:w-2/3 sm:mt-12 py-5 px-6 bg-white rounded-t-md border flex-col sm:flex-row grid grid-cols-1 sm:grid-cols-5 mx-auto gap-y-2 sm:my-0 my-5 font-rubik">
      <div className="flex flex-col gap-y-5 sm:items-start items-center border-b py-5 sm:py-0">
      ...
      <div className="flex flex-col sm:items-start  items-center gap-y-5 py-5 sm:py-0 border-b ">
      ...
      <div className="flex flex-col gap-y-5 sm:items-start items-center  py-5 sm:py-0 border-b">
