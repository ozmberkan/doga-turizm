...
const Announcement = () => {
  return (
    <div className="container w-full sm:w-2/3 h-full flex justify-center items-center mx-auto gap-y-2 sm:my-5 my-5 ">
      <div className="py-7 flex justify-center items-center font-rubik flex-col gap-y-2 w-[80%] bg-white rounded-md border sm:px-12 px-4 text-center sm:text-left">
