...
const Announcement = () => {
  return (
    <div className="container w-full sm:w-2/3 h-full flex justify-center items-center mx-auto gap-y-2 sm:my-5 my-5">
      <div className="py-7 flex justify-center items-center font-rubik flex-col gap-y-2 sm:w-full w-[80%] rounded-xl   sm:px-12 px-4 text-center sm:text-left">
        ...
        <div className="w-full h-full relative  shadow-xl">
          ...
          <div className="drop-shadow-sm hidden absolute left-5 max-w-[550px] top-52 -transform-y-1/2 gap-y-2 sm:flex p-3 flex-col">
            <span className="text-zinc-300 text-2xl font-semibold">
